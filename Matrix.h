...
public:
    ...
    int GetM();
    int GetN();
    void SetRazmernost(int width, int length);
    void SetMatric(M** e);
...
template<class M>
void Matric<M>::SetRazmernost(int width, int length)
{
    m = width;
    n = length;
}
